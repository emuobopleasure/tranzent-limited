export const SERVICES = [
  ...
  },
  {
    ...
    copy:
      "We coordinate simultaneous multi-vehicle movements — inter-state stock transfers, auction pickups, and rental repositioning — run through a single point of contact with consolidated reporting.",
