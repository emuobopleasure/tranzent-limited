        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-10">
          <Reveal>
            ...
            <p className="mt-6 max-w-md text-[16px] leading-relaxed text-ink-500">
              Tranzent was built on a simple belief: logistics shouldn&rsquo;t
              cost you your peace of mind. The name fuses <em className="not-italic text-ink-700 font-medium">transit</em> —
              the discipline of movement — with <em className="not-italic text-ink-700 font-medium">zen</em> — the
              calm that comes from knowing it&rsquo;s in good hands. That fusion is
              our operating standard, not a marketing line.
            </p>
          </Reveal>
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <Reveal delay={240} className="sm:col-span-2">
              <MediaFrame
                ...
                className="h-56 rounded-3xl sm:h-64"
                overlay="bottom"
                fallback={
                  <svg
